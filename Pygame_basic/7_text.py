...
# 캐릭터(스프라이트) 불러오기
character= pygame.image.load("C:/Users/Master/Desktop/Software/Python/Pygame_basic/character.png")
...
character_y_pos = screen_height - character_height # 화면 제일 아래에 위치 (세로)
...
# 적 enemy 캐릭터
enemy= pygame.image.load("C:/Users/Master/Desktop/Software/Python/Pygame_basic/enemy.png")
...
while running:
    ...
    # 타이머 집어 넣기
    # 경과 시간 계산
    elaped_time = (pygame.time.get_ticks() - start_ticks) / 1000
    # 경과 시간(ms)를 초 단위로 표시

    timer = game_font.render(str(int(total_time - elaped_time)), True, (255, 255, 255))
    # 출력할 글자, True, 글자 색상
